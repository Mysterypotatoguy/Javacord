...
/**
 * An immutable index which maps a Key to a Set of Values.
 *
 * @param <K> The type of the key.
 * @param <E> The type of the elements.
 */
public class MultiIndex<K, E> implements Index<K, E> {
     ...
     */
    public MultiIndex(Function<E, K> keyMapper) {
     ...
     */
    private MultiIndex(Function<E, K> keyMapper, Map<K, Set<E>> elementsByKey, Map<E, K> keyByElement) {
     ...
     */
    public MultiIndex<K, E> addElement(E element) {
        ...
        return new MultiIndex<>(keyMapper, newElementsByKey, newKeyByElement);
    }
     ...
     */
    public MultiIndex<K, E> removeElement(E element) {
